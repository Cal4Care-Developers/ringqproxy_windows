...
=================================================================================
 Removes:
   ...
   - C:\RingQProxy  (binary, config, logs, nssm.exe)
...
cat << 'EOF'
 ...
 |_| \_\_|_| |_|\__, | |_| \__,_|_| |_|_| |_|\___|_|
                |___/
  Windows Tunnel Uninstaller  v5.1
EOF
echo -e "${NC}"
...
foreach ($name in @("RingQ-phones-udp", "RingQ-phones-tcp", "RingQ-admin-lan", "RingQ-rtp-relay")) {
